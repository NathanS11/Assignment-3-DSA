                ...
                implements SearchTreeInterface<T>
{
                            ...
                            BinaryNode<T> parentNode)
    {
        ...
        {
            if(childNode != null)
                childNode.setThread(getRootNode().getThread());
        ...
        else if (parentNode.getLeftChild() == nodeToRemove)
        {
            if(childNode != null){
                ...
                if((parentNode.getParent() != null) && (parentNode.getParent().getData().compareTo(childNode.getData()) < 0))
                    parentNode.getParent().setThread(childNode);
            } else {
                if((parentNode.getParent() != null) && (parentNode.getParent().getData().compareTo(nodeToRemove.getData()) < 0))
                    parentNode.getParent().setThread(parentNode);
            }
        ...
        {
            if(childNode != null){
                parentNode.setThread(childNode); 
                if((parentNode.getParent() != null) && (parentNode.getParent().getData().compareTo(childNode.getData()) > 0))
                    childNode.setThread(parentNode.getParent());
            } else {
                if((parentNode.getParent() != null) && (parentNode.getParent().getData().compareTo(nodeToRemove.getData()) > 0))
                    parentNode.setThread(parentNode.getParent());
                else parentNode.setThread(null);
            }
